    ...
    <section className="bg-[#495e57] text-white">
        <div className="container mx-auto py-12 px-8 grid grid-cols-2">
          <div>
            ...
            <a href="#reverse" className="bg-[#f4ce14] text-black font-bold block w-fit py-1 px-4 mt-4 rounded-sm border hover:bg-transparent border-[#f4ce14] hover:text-white hover:border-white transition-colors duration-300 sm:py-2 sm:px-6 md:py-3 md:px-8 md:text-xl lg:py-4 lg:px-10 lg:text-3xl">Reserve a table</a>
          </div>
